...
@Schema(name = "UpdatePatientMetricsRequest", description = "Payload used by a nutritionist to update patient weight and height.")
public record UpdatePatientMetricsRequest(
        @Schema(description = "Updated patient weight in kilograms", example = "74.5")
        ...
        @Schema(description = "Updated patient height in centimeters", example = "180.0")
